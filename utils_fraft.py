...
class Object:
    def __init__(self):
        self.c_x = random.randint(0, 800)
        self.c_y = random.randint(0, 800)
        self.c_z = random.randint(0, 200)
        self.d_x = random.randint(1, 400)
        self.d_y = random.randint(1, 400)


def overlap(l1, r1, l2, r2):
    """
    Verifies whether a given box overlaps the other box.
    Parameters
    ----------
    l1:left top corner point (x,y) of first box
    r1:right bottom corner point (x,y) of first box
    l2:left top corner point (x,y) of second box
    r2:right bottom corner point (x,y) of second box
